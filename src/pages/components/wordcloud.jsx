...
function Word({ children, ...props }) {
  ...
  const clicked = (e) => {
    // console.log(e.object._private_text)
    // alert(e.object._private_text)
  }

  return <Text ref={ref} onPointerOver={over} onPointerOut={out} onClick={clicked} {...props} {...fontProps} children={children} />
}
